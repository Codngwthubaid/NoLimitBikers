...
const Card = (props) => {
    return (
        <>
            <div className='flex flex-col justify-center items-center text-center gap-y-3 border border-green-400 py-5 rounded-2xl text-gray-700 h-60 hover:bg-[#c1e1c1] px-2'>
                <div>
                    {/* <Image
                        src={props.img}
                        width={50}
